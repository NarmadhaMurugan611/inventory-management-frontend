...
export const Register = () => {
  ...
  const formSubmit = () => {
    ...
    if (name.value.length !== 0) {
      name.style.border = borderColorChange("green");
    }
    else {
      name.style.border = borderColorChange("red");
    }
    ...
    if (name.value.length !== 0 && email.value.length !== 0 && password.value.length !== 0 && confirmPassword.value.length !== 0 && password.value === confirmPassword.value && noEmailDuplex === false) {
      isEmailDuplicated();
    }
    ...
    <div className="registerPage">
      <div className="registerCard">
        ...
        <form className="registerForm">
          <input id="name" type="name" placeholder="Username" onChange={(e) => { setUserNameReg(e.target.value); }} required></input>
          ...
          <h5 className="forget-pass"><a href="/login">Login</a></h5>
